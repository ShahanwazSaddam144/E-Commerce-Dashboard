...
import { Trash2, AlertCircle, Check, TrendingUp, Package, ShoppingCart, Users } from "lucide-react";
...
const Hero = () => {
  ...
  const stats = [
    { label: "Total Products", value: products.length, icon: Package, color: "blue", bg: "bg-blue-50", text: "text-blue-600", border: "border-blue-200" },
    { label: "Total Orders", value: users.length, icon: ShoppingCart, color: "green", bg: "bg-green-50", text: "text-green-600", border: "border-green-200" },
    { label: "Total Revenue", value: "$810.23", icon: TrendingUp, color: "purple", bg: "bg-purple-50", text: "text-purple-600", border: "border-purple-200" },
    { label: "Active Users", value: users.length, icon: Users, color: "orange", bg: "bg-orange-50", text: "text-orange-600", border: "border-orange-200" }
  ];
      ...
      <section className="bg-gray-100 p-6 sm:p-8 lg:p-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8 animate-fade-in">
            <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">Welcome back, Admin! 👋</h1>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div className="p-6 border-b border-gray-200 bg-linear-to-r from-gray-50 to-white">
                  <div className="flex items-center justify-between">
                    ...
                    <button className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-all duration-300 transform hover:scale-105">
                      Add Product
                    </button>
                  </div>
                </div>
                ...
                <div className="p-6">
                  {products.length > 0 ? (
                          ...
                          <div className="bg-linear-to-br from-gray-50 to-white border border-gray-200 rounded-xl p-4 hover:shadow-lg transition-all duration-300 group h-full">
                            ...
                            <div className="space-y-3">
                              <div>
                                ...
                                <p className="text-blue-600 text-sm font-medium">{item.productCategory}</p>
                              </div>
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-gray-500 text-xs">({item.productReviews} reviews)</span>
                              </div>

                              {/* Description */}
                              <p className="text-gray-600 text-sm line-clamp-2">{item.productDesc}</p>
                    ...
                    <div className="flex flex-col items-center justify-center py-12">
                      ...
                      <p className="text-gray-500 text-sm mt-2">Start by adding your first product</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden h-full flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-3">
                  {users.map((user, i) => (
                    ...
                    >
                      <div className={`w-10 h-10 rounded-lg flex items-center justify-center text-white font-bold text-sm shrink-0 shadow-md ${getAvatarColor(i)}`}>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-green-600 font-semibold mt-1">{user.amount}</p>
                      </div>
                    </div>
                  ))}
                </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full animate-in fade-in zoom-in duration-300">
            ...
            <div className="p-6">
              <p className="text-gray-600 text-sm leading-relaxed">
                Are you sure you want to permanently delete this product? It will be removed from inventory and all orders.
              </p>
            </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
          <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full animate-in fade-in zoom-in duration-300">
            <div className="flex flex-col items-center justify-center p-8">
              ...
              <h2 className="text-xl font-bold text-gray-900 mb-2">Product Deleted!</h2>
